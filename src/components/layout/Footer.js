      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="flex space-x-4">
              <button className="text-dark-400 hover:text-primary-400 transition-colors duration-200">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/courses" className="text-dark-300 hover:text-white transition-colors duration-200">
                  Browse Courses
                </Link>
              </li>
              <li>
                <Link to="/register" className="text-dark-300 hover:text-white transition-colors duration-200">
                  Join as Student
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <button className="text-dark-300 hover:text-white transition-colors duration-200">
                  Help Center
                </button>
              </li>
              <li>
        ...
        <div className="border-t border-dark-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-dark-400 text-sm">
            © 2024 Areeb Learning Platform. All rights reserved.
          </p>
